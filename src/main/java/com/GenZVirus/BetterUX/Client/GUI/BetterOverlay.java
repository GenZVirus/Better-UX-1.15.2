...
public class BetterOverlay {
	...
	public static void renderHealth() {
		...
		AbstractGui.blit(HealthPosX + 1, HealthPosY + 1, 0, 0, 0, percentage, 8, 8, 88);
		...
		mc.fontRenderer.drawString(health, HealthPosX + 45 - stringWidth / 2 + (stringWidth - offset), HealthPosY + 1, 0xFFFFFFFF);
	...
	public static void renderArmor() {
		...
		RenderSystem.enableBlend();
		XMLFileJava.checkFileAndMake();
		int leftShieldPosX = mc.getMainWindow().getScaledWidth() / 2 + Integer.parseInt(XMLFileJava.readElement("LeftShieldPosX"));
		int leftShieldPosY = mc.getMainWindow().getScaledHeight() + Integer.parseInt(XMLFileJava.readElement("LeftShieldPosY"));
		
		int rightShieldPosX = mc.getMainWindow().getScaledWidth() / 2 + Integer.parseInt(XMLFileJava.readElement("RightShieldPosX"));
		int rightShieldPosY = mc.getMainWindow().getScaledHeight() + Integer.parseInt(XMLFileJava.readElement("RightShieldPosY"));
		...
		mc.fontRenderer.drawString(s, leftShieldPosX + 16 - mc.fontRenderer.getStringWidth(s) / 2, leftShieldPosY + 10, 0xFFFFFFFF);
		...
		if (damageReduction > 100)
			damageReduction = 100;
		s = damageReduction + "%";
		mc.fontRenderer.drawString(s, rightShieldPosX + 17 - mc.fontRenderer.getStringWidth(s) / 2, rightShieldPosY + 10, 0xFFFFFFFF);
		RenderSystem.disableBlend();
		mc.getProfiler().endSection();
	}
