...
public class VampirismComp {
	...
	public static void bloodOverlay() {
		...
		if (!VampirismAPI.getFactionPlayerHandler((mc.player)).map(h -> VReference.VAMPIRE_FACTION.equals(h.getCurrentFaction())).orElse(false)) {
			...
			AbstractGui.blit(BetterOverlay.foodPosX - 89 + 88 - BetterOverlay.foodPercentage, BetterOverlay.foodPosY + 1, 0, 88 - BetterOverlay.foodPercentage, 0, BetterOverlay.foodPercentage, 8, 8, 88);
			...
			AbstractGui.blit(BetterOverlay.foodPosX - 89 + 88 - BetterOverlay.saturationPercentage, BetterOverlay.foodPosY + 1, 0, 88 - BetterOverlay.saturationPercentage, 0, BetterOverlay.saturationPercentage, 8, 8, 88);
			...
			if (mc.player.getHeldItemMainhand().isFood() || mc.player.getHeldItemOffhand().isFood()) {
				...
				AbstractGui.blit(BetterOverlay.foodPosX - 89 + 88 - BetterOverlay.addedFoodPercentage, BetterOverlay.foodPosY + 1, 0, 88 - BetterOverlay.addedFoodPercentage, 0, BetterOverlay.addedFoodPercentage, 8, 8, 88);
				...
				AbstractGui.blit(BetterOverlay.foodPosX - 89 + 88 - BetterOverlay.addedSaturationPercentage, BetterOverlay.foodPosY + 1, 0, 88 - BetterOverlay.addedSaturationPercentage, 0, BetterOverlay.addedSaturationPercentage, 8, 8, 88);
			...
			AbstractGui.blit(posX - 89 + 88 - percentage, posY + 1, 0, 88 - percentage, 0, percentage, 8, 8, 88);
